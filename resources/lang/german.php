...
$lang = [
    ...
    'attachments_links' => 'Links zu Anhängen (*.png, *.jpg, *.gif, *.aac, *.3gp, *.amr, *.mp3, *.m4a, *.wav, *.mp4, *.txt, *.vcf)',
    'attachments' => 'Anhänge (*.png, *.jpg, *.gif, *.aac, *.3gp, *.amr, *.mp3, *.m4a, *.wav, *.mp4, *.txt, *.vcf)',
    'type' => 'Art',
