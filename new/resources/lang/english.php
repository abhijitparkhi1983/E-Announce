...
$lang = [
    ...
    'attachments_links' => 'Links to attachments (*.png, *.jpg, *.gif, *.aac, *.3gp, *.amr, *.mp3, *.m4a, *.wav, *.mp4, *.txt, *.vcf)',
    'attachments' => 'Attachments (*.png, *.jpg, *.gif, *.aac, *.3gp, *.amr, *.mp3, *.m4a, *.wav, *.mp4, *.txt, *.vcf)',
    'type' => 'Type',
...
In the above example, the system will replace %name% with data from the Name column. You must have Name column in your Excel file for it to work.',
    ...
    'debug' => 'Debug',
    'username' => 'Username',
    'application_copyright' => '<strong>Copyright &copy; %present% <a href="%url%" id="company_url">%name%</a></strong>. All rights
    reserved.',
